...
$philomessage[189] = "A Line by Line (KIWC) Report cannot be sorted for results of more than 20,000 occurrences. Please refine your search.  Contact $ERRORCONTACT to have this limit increased.";
$philomessage[190] = "<b>Line by Line (KIWC) Report</b><br> Sorted by keyword and words to its %s.";
...
$philomessage[240] = "Click <A HREF=\"%s/select.pl?%s\">here</A> to run a search on selected parts of this documents.";
...
$philomessage[308] = "<b>Line by Line (KIWC) Report</b><br> Sorted by %s";
