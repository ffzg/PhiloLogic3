...
/*
	      stops_fp=fopen(getresource(resourcetype_filename, TYP3FILE),"r");
	      if (stops_fp==NULL) fprintf(stderr,"problem opening TYP3FILE\n");
 */
          ...
          *blkcount=0;
          ...
          if(val.dptr==NULL)
             {
                /* fprintf(stderr,"gdbm bullshit problems...\n");	*/
	        /* word not found */
