...
Gmap
retreive_hit_block_booleannot ( Search s, N8 bn, Word w, N32 n, Gmap map, Gmap res, Z32 *howmany )
{
  Z32 status   = 0;
  ...
  */  
  ...
  hits->gm_h =  hit_gethits ( w->type, gm_get_pos ( w->dir, n ), w->offset, howmany );
  hits->gm_l =  *howmany; 
...
Gmap
retreive_cached_hits_booleannot ( Search s, N8 bn, Word w, N32 n, Gmap map, Gmap res, Z32 *howmany )
{
  Gmap hits    = NULL; 
  Z32 *map_ptr = gm_get_cur_pos ( map );
  Z32 *res_ptr = NULL;
...
Z32 load_hits ( Search s, Gmap hits, Z32 howmany, Gmap res )
{
  Z32  ctr; 
  Z32 *res_ptr;
  Z32  status;
...
Z32 filternload_hits ( Search s, N8 bn, Word w, N32 n, Gmap map, Gmap hits, Z32 howmany, Gmap res )
{
  Z32 status = 0; 
  Z32 put_status = 0; 
